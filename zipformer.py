...
def model_params(scale="medium") -> AttributeDict:
...
def get_zipformer_model(scale="medium") -> nn.Module:
...
def _test_zipformer_main(scale="medium"):
    model, params = get_zipformer_model(scale)
    ...
    f = model(
        torch.randn(batch_size, seq_len, params.feature_dim),
