...
def generate_data(
    ...
    encoder_in = torch.rand(
        N, max_T, encoder_in_dim, requires_grad=True, device=device
    )
    encoder_in_lengths = shape_info[:, 0].contiguous()

    return encoder_in, encoder_in_lengths
